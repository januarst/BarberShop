...
<html lang="en">
<head>
<title>Pak Kumis Barbershop | Shop</title>
<meta charset="utf-8">
    ...
    <div class="container_12">
        ...
        <div class="car_wrap">
          ...
          <ul class="carousel1">
            ...
            <li>
            <form method="post" action="process/addCartProcess.php?code=<?php echo $row['ID']; ?>">
              <div><img src="<?php echo $row['image_Produk']; ?>" alt="">
                <div class="col1 upp"><?php echo $row['nama_Produk']; ?></div>
                <div>IDR <?php echo $row['harga_Produk']; ?></div>
                <div>Diskon = <?php echo $row['diskon']; ?>%</div>
                <div><input type="text" name="quantity" value="1"><input type="submit" value="Add"></div>
              </div>
            </form>
            </li>
