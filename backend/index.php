...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
          <h1>Hello <?php if(isset($_SESSION['is_logged_in']))echo $_SESSION['username']; ?></h1>
          <p>Ini adalah index kusus untuk admin. Disini anda dapat menambah produk/jasa, menghapus produk/jasa, mengedit produk/jasa dll.</p>
        </div>
      </div>
    </div>
    <!-- /.container-fluid-->
