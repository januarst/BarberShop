        ...
        <div class="col-12">
          <?php
            ...
            <tr>
              ...
              <td>Message</td>
              <td>Status</td>
              <td colspan="2">Respon</td>
            </tr>
          <?php while($row = $result->fetch_assoc()){
                echo "<tr>";
                $query = "SELECT * FROM userdetail WHERE User_ID = ". $row['User_ID'];
                ...
                echo "<td> <a href=process/respon.php?action=terima&code=". $row['ID'] .">Terima</a> </td>";
                echo "<td> <a href=process/respon.php?action=tolak&code=". $row['ID'] .">Tolak</a> </td>";
                }else{
