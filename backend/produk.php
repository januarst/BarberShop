      ...
      <div class="row">
        <div class="col-12">
          <?php
            ...
            $result = $db->query($query);?>
            <a href="addProduk.php">Add New</a>
          ...
          <?php while($row = $result->fetch_assoc()){
                ...
                echo "<td>". $row['code_Produk'] ."</td>";
                echo "<td>". $row['image_Produk'] ."</td> ";
                echo "<td>". $row['diskon'] ."</td>";?>
                <td> <a href="editProduk.php?code=<?php echo $row['ID']; ?>">Edit</a> </td>
                <td> <a href="produk.php?action=hapus&code=<?php echo $row['ID']; ?>">Hapus</a> </td>
              <?php  
                echo "</tr>";
              }
            echo "</table>";
